...
public class RGBController implements ConnectionListener {
    ...
    public void setRGBView(final RoomData selectedRoom) {
        ...
        activity.findViewById(R.id.scrollView).setVisibility(View.GONE);
        activity.findViewById(R.id.rgbPanel).setVisibility(View.VISIBLE);
        activity.findViewById(R.id.emptydevicepanel).setVisibility(View.GONE);
