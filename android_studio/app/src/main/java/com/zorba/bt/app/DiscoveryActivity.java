...
public class DiscoveryActivity extends ZorbaActivity {
    ...
    private void presettingsForDiscovery() {
        ...
        if (!little.isRunning())
            little.start();
        saveButton.setEnabled(false);
        findViewById(R.id.spinnertriangle).setVisibility(View.GONE);
    ...
    private void stopDiscoveryProcess() {
        this.runOnUiThread(new Runnable() {
            public void run() {
                ...
                DiscoveryActivity.this.findViewById(R.id.spinnertriangle).setVisibility(0);
    ...
    protected void onCreate(Bundle var1) {
		...
		*/
        ...
        saveButton.setEnabled(false);
        this.findViewById(R.id.spinnertriangle).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
