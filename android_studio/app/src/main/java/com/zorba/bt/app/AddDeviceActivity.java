...
public class AddDeviceActivity extends ZorbaActivity {
    ...
    private void initListeners() {
        this.findViewById(R.id.cancel).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
                AddDeviceActivity.this.finish();
            }
        });
        this.findViewById(R.id.save).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
    ...
    protected void onCreate(Bundle var1) {
        ...
        findViewById(R.id.powerLayout).setVisibility(View.GONE);
