...
public class MyComp extends LinearLayout {
    ...
    public MyComp(Context context, String compName, int maxComps, boolean isEditNeeded) {
        ...
        this.findViewById(R.id.collapseheader).setOnClickListener(new ZorbaOnClickListener() {
        ...
        this.findViewById(R.id.addbutton).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
                MyComp.this.deselectAll();
                MyComp.this.doAddAction();
            }
        });
        this.findViewById(R.id.configbutton).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
                MyComp.this.deselectAll();
        ...
        this.findViewById(R.id.deletebutton).setOnClickListener(new ZorbaOnClickListener() {
            public void zonClick(View var1) {
