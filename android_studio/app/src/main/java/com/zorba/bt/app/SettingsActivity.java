...
public class SettingsActivity extends ZorbaActivity {
    ...
    private void timeSettings() {
        ...
        this.findViewById(R.id.setTimeButton).setOnClickListener(new ZorbaOnClickListener() {
        ...
        this.findViewById(R.id.getTimeButton).setOnClickListener(new ZorbaOnClickListener() {
    ...
    private void oohSettings() {
        ...
        this.findViewById(R.id.enableOOHButton).setOnClickListener(new ZorbaOnClickListener() {
        ...
        this.findViewById(R.id.disableOOHButton).setOnClickListener(new ZorbaOnClickListener() {
        ...
        this.findViewById(R.id.readOOHStatusButton).setOnClickListener(new ZorbaOnClickListener() {
        ...
        // ZorbaOnClickListener() {
        this.findViewById(R.id.resetESBButton).setOnClickListener(new ZorbaOnClickListener() {
    ...
    private void changepwdSettings() {
        ...
        // ZorbaOnClickListener() {
        this.findViewById(R.id.cancelButton).setOnClickListener(new ZorbaOnClickListener() {
        ...
        // {
        this.findViewById(R.id.saveButton).setOnClickListener(new ZorbaOnClickListener() {
    ...
    private void gatewaySettings() {
        ...
        // ZorbaOnClickListener() {
        this.findViewById(R.id.setGatewayIPButton).setOnClickListener(new ZorbaOnClickListener() {
